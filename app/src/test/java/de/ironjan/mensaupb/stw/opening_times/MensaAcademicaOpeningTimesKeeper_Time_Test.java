...
public class MensaAcademicaOpeningTimesKeeper_Time_Test extends TestCase {
    ...
    @Test
    public void mensaAcademicaCloseAt_1400_Monday_to_Thursday() {
        fail("niy");
    }

    @Test
    public void mensaAcademicaCloseAt_1330_on_Friday() {
        fail("niy");
    }
}